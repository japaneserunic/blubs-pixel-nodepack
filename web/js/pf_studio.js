...
console.info("[PixelForge] pf_studio v3.7.8-regionvote — TruePixel region vote + median-signal classification (no deepfry), one-color outline");
const PFS_VERSION = "v3.7.8-regionvote";
