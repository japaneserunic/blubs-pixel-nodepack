...
console.info("[PixelForge] pf_studio v3.10.8-fracgrid - gen-native ref snap ALWAYS (guard trip = WARN only; explicit on = guarded) (py v3.10.7) — gen-native snap-ALL to ref palette + eye-glint rescue 10% (py v3.10.6)");
const PFS_VERSION = "v3.10.8-fracgrid";
